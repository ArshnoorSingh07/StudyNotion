...
const Catalog = () => {
    ...
    const [catalogPageData, setCalatogPageData] = useState(null);
  ...
  return (
    <div className=" box-content bg-richblack-800 px-4" >
        ...
        <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
          ...
          <div className="my-4 flex border-b border-b-richblack-600 text-sm">Courses to get you started</div>
